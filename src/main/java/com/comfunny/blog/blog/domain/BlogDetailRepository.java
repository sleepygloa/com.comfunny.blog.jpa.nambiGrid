...
public interface BlogDetailRepository extends JpaRepository<BlogDetail, Long> {
    ...
    @Query(value = "SELECT b.CATEGORYA, b.CATEGORYB, b.CATEGORYC, b.TITLE, bd.* FROM blog b INNER JOIN blog_detail bd ON b.IDX = bd.IDX WHERE b.IDX = :idx ORDER BY bd.IDX ASC", nativeQuery = true)
